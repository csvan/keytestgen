...
public class ModelArrayTest extends ModelTest {
    ...
    @Test
    public void ObjectArrayIndexWriteAccess() throws ModelGeneratorException, ProofInputException {
    ...
    public void ArrayIndexWriteAccess() throws ModelGeneratorException, ProofInputException {
        ...
        IExecutionNode node = getFirstSymbolicNodeForStatement("ArrayIndexWriteAccess.compute", null);
    }

    @Ignore
    @Test
    public void SimpleArrayLength() throws ModelGeneratorException, ProofInputException {
    ...
    @Ignore
    @Test
    public void ArrayInstanceCreationTest() throws ModelGeneratorException, ProofInputException {
    ...
    @Ignore
    @Test
    public void ArrayIndexReadAccess() throws ModelGeneratorException, ProofInputException {
    ...
    @Ignore
    @Test
    public void VariablesArrayTest() throws ModelGeneratorException, ProofInputException {
    ...
    @Ignore
    @Test
    public void MultiArrayIndexReadWriteAccess() throws ModelGeneratorException, ProofInputException {
    ...
    @Ignore
    @Test
    public void SimpleArrayCreation() throws ModelGeneratorException, ProofInputException {
